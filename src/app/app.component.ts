...
export class AppComponent {
  ...
  disciplinas = [
    ...
    new Disciplina(2,'Educação Física', new Professor('Madia'), 'A Educação Física é o componente curricular ' +
    ...
    new Disciplina(3,'Inglês', new Professor('Parcilene'), 'Aprender a língua inglesa propicia a criação de novas ' +
    ...
    new Disciplina(4,'Matemática', new Professor('Cristina'), 'No Ensino Fundamental, essa área, por meio da ' +
    ...
    new Disciplina(5,'Ciências', new Professor('Fábio'), 'Ao estudar Ciências, as pessoas aprendem a respeito ' +
